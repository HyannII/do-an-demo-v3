...
export default function TrafficLightCalculationPage() {
      ...
      <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Tính toán thời gian đèn tối ưu dựa trên số lượng phương tiện và các
            tham số kỹ thuật
          </p>
        </div>
          ...
          <div className="pb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Thời gian tất cả đèn đỏ để đảm bảo khoảng trống an toàn khi
                  chuyển pha
                </p>
                <input
                  type="number"
